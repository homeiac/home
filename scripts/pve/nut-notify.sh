...
#
# Called by upsmon via NOTIFYCMD when UPS events occur.
...
#
# Environment variables from upsmon:
#   UPSNAME - Name of the UPS (e.g., "ups")
#   NOTIFYTYPE - Event type (ONLINE, ONBATT, LOWBATT, FSD, etc.)
